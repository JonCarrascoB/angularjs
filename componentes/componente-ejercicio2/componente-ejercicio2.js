...
component('componenteEjercicio2', { 
  templateUrl: './componentes/componente-ejercicio2/componente-ejercicio2.html',
  controller: function profesorCtrl($scope,$timeout) {
    ...
    controller: function videoCtrl($scope,$timeout) {
    ...
    controller: function frutasCtrl($scope,) { 
